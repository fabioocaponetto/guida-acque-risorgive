...
const showCard = (feature) => {
    ...
    document.querySelectorAll('.more-button').forEach(item => {
        item.addEventListener('click', async () => { // <-- funzione async qui!
            ...
            overlay.innerHTML = `
                <div class="overlay-content">
                    ...
                    <div class="button-scelta">
                        ...
                        <div>
                            <button id="mostra-img">CONFRONTA</button>
                        </div>
                    </div>
              ...
              function renderGrid(groups, tutteLeImmagini) {
                  ...
                  Object.entries(groups).forEach(([classe, images], index, array) => {
                    ...
                    //   label.style.fontWeight = 'bold';
                      ...
                      // Trova i dati completi associati a questa immagine
                      ...
                      // Posizione iniziale sopra l'immagine
                      ...
                      const scrollLeft = overlay.pageXOffset;
                      const scrollTop = overlay.pageYOffset;
                      ...
                      const sbordaOrizzontalmente = left + tooltipRect.width + 100 > overlayWidth;
                      const sbordaVerticalmente = top + tooltipRect.height + 100 > overlayHeight;
            ...
            document.querySelector('#areatempo2').style.opacity = '0.2';
            document.querySelector('#areatempo2').style.display = 'block';
            document.querySelector('#areatempo3').style.opacity = '0.2';
            document.querySelector('#areatempo3').style.display = 'block';
            document.querySelector('#areatempo4').style.opacity = '0.2';
            document.querySelector('#areatempo4').style.display = 'block';

            let imgVisibili = false;
            let vizSatellite = true;
            let vizAcqua = false;
            let vizFlora = false;
            ...
            areaDivs.forEach((areaDiv, index) => {
                ...
                areaDiv.addEventListener('mouseenter', () => {
                    if (!imgVisibili) {
                        areaImgs.forEach((img, j) => {
                            img.style.opacity = j === index ? '1' : '0.2';
                            img.style.display = 'block'; // assicurati che tutte siano visibili
                        });

                        areaDivs.forEach((div, j) => {
                            div.querySelector('p').style.display = j === index ? 'none' : 'block';
                        });
                    }
                ...
                areaDiv.addEventListener('mouseleave', () => {
                    if (!imgVisibili) {
                        areaImgs[index].style.opacity = '0.2';
                        areaDiv.querySelector('p').style.display = 'block';
                    }
            ...
            document.querySelector('#mostra-img').addEventListener('click', () => {
                if (imgVisibili === false) {
                    document.querySelector('#areatempo1').style.opacity = '1';
                    document.querySelector('#areatempo1').style.display = 'block';
                    ...
                    document.querySelector('#areatempo4').style.display = 'block';
                    document.querySelector('.areatempo1 p').style.display = 'none';
                    document.querySelector('.areatempo2 p').style.display = 'none';
                    document.querySelector('.areatempo3 p').style.display = 'none';
                    document.querySelector('.areatempo4 p').style.display = 'none';

                    document.querySelector('#mostra-img').innerHTML = '<code>NASCONDI<code/>';

                    document.querySelector('#mostra-img').style.backgroundColor = 'transparent';
                    document.querySelector('#mostra-img').style.color = '#1f18c0';

                    imgVisibili = true;
                } else {
                    document.querySelector('#areatempo1').style.opacity = '0.2';
                    document.querySelector('#areatempo1').style.display = 'block';
                    document.querySelector('#areatempo2').style.opacity = '0.2';
                    document.querySelector('#areatempo2').style.display = 'block';
                    document.querySelector('#areatempo3').style.opacity = '0.2';
                    document.querySelector('#areatempo3').style.display = 'block';
                    document.querySelector('#areatempo4').style.opacity = '0.2';
                    document.querySelector('.areatempo1 p').style.display = 'block';
                    document.querySelector('.areatempo2 p').style.display = 'block';
                    document.querySelector('.areatempo3 p').style.display = 'block';
                    document.querySelector('.areatempo4 p').style.display = 'block';

                    document.querySelector('#mostra-img').innerHTML = '<code>CONFRONTA</code>';

                    document.querySelector('#mostra-img').style.backgroundColor = '#1f18c0';
                    document.querySelector('#mostra-img').style.color = '#f7f7f7';

                    imgVisibili = false;
                }
            });

            document.querySelector('#mostra-img').addEventListener('mouseenter', () => {
                document.querySelector('#mostra-img').style.backgroundColor = 'black';
                document.querySelector('#mostra-img').style.color = '#f7f7f7';
            });

            document.querySelector('#mostra-img').addEventListener('mouseleave', () => {
                if (imgVisibili === true) {
                    document.querySelector('#mostra-img').style.backgroundColor = 'transparent';
                    document.querySelector('#mostra-img').style.color = '#1f18c0';
                } else {
    ...
    //zooma sull'area scelta
    map.flyTo({
        center: feature.properties.center.split(',').map(Number),
        zoom: feature.properties.zoom,
        speed: 1.8, // velocità dell'animazione
        curve: 1.4, // dolcezza del movimento
        essential: true // forza l'animazione anche se l'utente ha 'prefers-reduced-motion'
    });
